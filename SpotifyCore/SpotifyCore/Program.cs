            ...
            do
            {
...

                {
                    case "1":
                        ...
                        //Console.WriteLine("Ange plats. T.ex 1,2,3");
                        //tempArtist = Convert.ToUInt32(Console.ReadLine());
                        //Artist artist1 = new Artist();
                        //artist1.plats = tempArtist;
                        Artist artist1 = new Artist();
                    ...
                    case "2":
                        //Console.WriteLine("Ange plats. T.ex 1,2,3");
                        //tempAlbum = Convert.ToUInt32(Console.ReadLine());
                        //artist1.plats = tempAlbum;
